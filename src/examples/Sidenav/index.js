...
import { entryRoom911 } from "services/apis/incomeRecord/incomeRecord";
...
function Sidenav({ color, brand, brandName, routes, ...rest }) {
  ...
  const handleEntryRoom = () => {
    const identification = document.getElementById("access-employee").value;
    entryRoom911(identification)
      .then((resp) => {
        ...
        <MDSnackbar
          ...
          content={
            <MDBox alignItems="center" lineHeight={0} sx={{ p: 2 }}>
              <form>
                <TextField id="access-employee" label="Empleoyee ID" fullWidth sx={{ mb: 3 }} />
              </form>
              <Stack spacing={2}>
                <Button variant="contained" style={{ color: "white" }} onClick={handleEntryRoom}>
                  <Login /> Access
                </Button>
              </Stack>
            </MDBox>
